...
public class SumPairsFinding {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(distinctCounts);
    }

    public static List<Integer> countDistinct(int[] arr, int k) {
        List<Integer> result = new ArrayList<>(); // using the list to store
        HashSet<Integer> set = new HashSet<>(); // using set to store the element
